...
namespace eosio { namespace vm {
   ...
   class execution_context {
    ...
    private:
      ...
      maybe_allocator<bounded_allocator> _base_allocator = bound_allocator::init(
            (constants::max_stack_size + constants::max_call_depth + constants::max_nested_structures) *
            sizeof(stack_elem));
      uint32_t                        _pc               = 0;
      uint32_t                        _exit_pc          = 0;
