...
namespace eosio { namespace vm {
   ...
   struct guarded_ptr {
      ...
      inline void add_bounds(size_t n) { bnds += n; }

      inline void fit_bounds() { bnds = raw_ptr; }

      inline void fit_bounds(size_t n) { bnds = raw_ptr + n; }
      ...
      inline T at() const { return *raw_ptr; }
